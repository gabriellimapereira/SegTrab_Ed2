...
void nascidosQueNaoMoram(ArvRubNeg *pessoas, int *quantidade, ArvRubNeg *cidade);//6
void moradoresNaoNascidos(ArvRubNeg *pessoas, int *quantidade, ArvRubNeg *cidade);//7